...
<div id="wrapper">
    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    <li class="show"><img src="xres/images/jb2/001.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/002.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/003.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/004.jpg" width="861" height="379"  alt="" /></li>
					<li><img src="xres/images/jb2/005.jpg" width="861" height="379"  alt="" /></li>
					<li><img src="xres/images/jb2/006.jpg" width="861" height="379"  alt="" /></li>
					<li><img src="xres/images/jb2/007.jpg" width="861" height="379"  alt="" /></li>
					<li><img src="xres/images/jb2/008.jpg" width="861" height="379"  alt="" /></li>
					<li><img src="xres/images/jb2/009.jpg" width="861" height="379"  alt="" /></li>
					<li><img src="xres/images/jb2/010.jpg" width="861" height="379"  alt="" /></li>
					<li><img src="xres/images/jb2/011.jpg" width="861" height="379"  alt="" /></li>
              </ul>
    ...
    <div id="featured">
        <div id="items">
            ...
            <p><a href="#"><strong>15% Discount</strong><br />
			Using Dutch Bangla Bank Ltd. & Brac Bank Ltd. Cradit Card<br /> Only Dhk to Cox's Bazar</p>  
            </div>
            <div class="item"> <a href="lodging.php"><img src="xres/images/02_featured.jpg" alt="" /></a>
            <h3><a href="lodging.php">Safety First</a></h3>
            <p><a href="#"><strong>Happy Journey</strong><br />
			Treasure the happy memories, enjoy today and enjoy the trip.</p>  
	...
	<div id="footer">
	<h4>+8801926789870 &bull; <a href="contact-us.php">Palki  Bus Scheduling system limited, 2nd Floor, Bus Bhaban, Panthapath, Dhaka-1212 </a></h4>
